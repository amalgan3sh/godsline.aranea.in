        ...
        <div class="main-navigationbar">
            <div class="container">
                <div class="navigationbar-row d-flex align-items-center">
                    ...
                    <div class="logo-col">
                        <a href="index.html">
                            <img src="assets/images/ARANEA_WHITE.png" alt="">
                        </a>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-5 col-12"> 
                        <div class="common-banner-content">
                            ...
                            <p> Aranea Platform is dedicated to fostering collaboration and innovation. For inquiries or to discuss how 
                                we can collaborate, please reach out to us. Our mission is to create a seamless environment that supports collaboration 
                                among various stakeholders, including corporations, ventures, and strategic partners.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-5 col-12 contact-left-column">
                        <div class="contact-left-inner row">
                            <ul class="col-sm-10 col-12"> 
                                <li>
                                    <h4>Contact person:</h4>
                                    <p><a href="tel:+48 0021-32-12">Shynesh Moolayi</a></p>
                                </li> 
                                <li>
                                    <h4>Call us:</h4>
                                    <p><a href="tel:+48 0021-32-12">+91 974 4334 141</a></p>
                                </li> 
                                <li>
                                    <h4>Email:</h4>
                                    <p><a href="mailto:shop@company.com">shyneshmoolayi@gmail.com</a></p>
                                </li> 
                            </ul>
                            ...
                            <form class="contact-form" >
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="last-name" name="last" class="form-control" placeholder="Doe" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label>E-mail<sup aria-hidden="true">*</sup>:</label>
                                            <input type="email" class="form-control" id="email" name="email" placeholder="shop@company.com" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label>Telephone<sup aria-hidden="true">*</sup>:</label>
                                            <input type="number" class="form-control" id="telephone" name="telephone" placeholder="1234567890" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            <label>Subject<sup aria-hidden="true">*</sup>:</label>
                                            <input type="input" class="form-control" id="subject" name="subject" placeholder="Subject" required>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea  class="form-control" name="message" id="message" placeholder="How can we help?" rows="8"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row align-items-center"> 
                                    ...
                                    <div class="col-lg-4 col-12"> 
                                        <button class="btn submit-btn" type="submit" id="submitButton">
                                            Send message 
    ...
    <script>
        // $(document).ready(function() {
            $('#submitButton').click(function(event) {+
                ...
                var termsChecked = $('#ch1').is(':checked');
            ...
            var formData = {
                ...
                // Validate telephone (at least 10 digits)
                ...
                // If validation fails, show alert, else submit the form
                if (!isValid) {
                    alert(errorMessage);
                } else {
                    ...
                    console.log('sdcsd');
                    $.ajax({
                        url: '<?= site_url('submit_contact') ?>', // Point to the controller method
                        type: 'POST',
                        dataType: 'json',
                        ...
                        success: function(response) {
                            ...
                            if (response.success) {
                                $('#feedback').html('<p style="color:green;">' + response.message + '</p>');
                                // $('#contactForm')[0].reset(); // Reset form
                            } else if (!response.success) {
                                $('#feedback').html('<p style="color:red;">' + response.error + '</p>');
                            } 
                        },
                        error: function() {
                            // $('#feedback').html('<p style="color:red;">An error occurred. Please try again.</p>');
                        }
                    });
                }
            });
            ...
            // Telephone validation function (at least 10 digits)
            function validatePhoneNumber(telephone) {
                var regex = /^\d{10,}$/; // Minimum 10 digits
